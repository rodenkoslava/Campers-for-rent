import{u as t,g as o,c as g,j as e,s as n,d as j,e as m,a as x,f as b,C as f,b as y}from"./index-CwYwv72A.js";import{b as v,a as k,C as w}from"./CampersList-DYXGkv-H.js";import{F as $,a as C,b as F}from"./formik.esm-D2CZrnfb.js";import{a as q,s as L}from"./selectors-CbC4wo0s.js";import"./ModalWindow-Vswq9XG1.js";const T=t.h3`
  font-weight: 500;
  color: ${o.lightText};
  margin-bottom: 15px;
  margin-top: 30px;
...
`,E=()=>{const a=g(),l=x(v);return e.jsx(V,{children:e.jsxs(z,{htmlFor:"location",children:["Location",e.jsx(A,{type:"text",id:"location",value:l,placeholder:"City, country",onChange:p=>a(b(p.target.value))}),e.jsx(B,{children:e.jsx("use",{href:n+"#icon-location"})})]})})},W=t.div`
  ...
  flex-direction: row;
  gap: 64px;
`,P=()=>{const a=x(k);x(q);const l=x(L);return e.jsx(f,{children:e.jsxs(W,{children:[e.jsxs("div",{children:[e.jsx(E,{}),e.jsx(S,{})]}),l?e.jsx(y,{}):e.jsx(w,{campers:a,pathForModal:"catalog"})]})})};export{P as default};
