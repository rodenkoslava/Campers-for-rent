import{f as I,u as s,g as x,r as g,b as $,a as F,j as e,s as S,h as _,i as B,k as R}from"./index-Bp4wV4b4.js";import{b as E}from"./selectors-CbC4wo0s.js";import{s as c}from"./sprite-zfA8R3ds.js";import M from"./ModalWindow-eOAl_Rjo.js";const O=t=>t.favorites.favoritesCampers,P=t=>t.filter.location,z=t=>t.filter.equipment,N=t=>t.filter.type,pe=I([E,P,z,N],(t,n,i,l)=>{const a=n.toLowerCase().trim().split(",").map(r=>r.trim()),[d,p]=a;let o=t;return i&&(o=o.filter(r=>r.details&&(r.details[i]||r.details[i]===void 0))),l&&(o=o.filter(r=>r.form===l)),o.filter(r=>{const[u,h]=r.location.toLowerCase().split(", ");return(!d||h.includes(d))&&(!p||u.includes(p))})}),T=s.li`
...
`,xe=({campers:t,pathForModal:n})=>{const[i,l]=g.useState(4),a=4,d=t.slice(0,i),p=()=>{l(i+a)};return e.jsxs(ne,{children:[e.jsx(oe,{children:d.map(o=>e.jsx(ie,{camper:o,pathForModal:n},o._id))}),i<t.length&&e.jsx(re,{onClick:p,children:"Load more"})]})};export{xe as C,pe as a,P as b,O as s};
